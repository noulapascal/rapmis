...
use App\Repository\SectionEducRepository;
use App\Entity\City;
use App\Entity\Country;
use Symfony\Component\Form\FormInterface;


class UserSeducType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
       ...
       'expanded'=>FALSE
                ...
                'required'=>true,
                    ...
                    return $er->getRegionsPerCountry($id);
                        ...
                        ->add('obedience', EntityType::class, array(
                'class'=>'App\Entity\SectionEduc',
                'placeholder'=>'selectionnez l\'obedience',
                'required'=>true,
//                    'query_builder' => function (RegionsRepository $er) use ($id) {
//                    return $er->getRegionsPerCountry($id);
//                }  
